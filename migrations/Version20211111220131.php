...
final class Version20211111220131 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contenu (id INT AUTO_INCREMENT NOT NULL, fiche_id INT DEFAULT NULL, rubrique VARCHAR(30) NOT NULL, description VARCHAR(1000) NOT NULL, INDEX IDX_89C2003FDF522508 (fiche_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
